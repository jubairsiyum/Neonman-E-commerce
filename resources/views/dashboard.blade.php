        ...
        <div class="lg:col-span-3">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <div class="p-16 text-center">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-3">No orders yet</h3>
                    <p class="text-gray-600 dark:text-gray-400 mb-8">Start shopping to see your orders here!</p>
