...
<div class="w-full max-w-md mx-auto">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input 
                        ...
                        class="w-full px-3.5 py-2.5 bg-gray-50 dark:bg-gray-900/50 border border-gray-300 dark:border-gray-700 rounded-lg text-gray-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all @error('name') border-red-500 focus:ring-red-500 @enderror" 
                        required 
                        autofocus 
                        autocomplete="name"
                    />
                ...
                <div>
                    ...
                    <input 
                        ...
                        placeholder="••••••••" 
                        class="w-full px-3.5 py-2.5 bg-gray-50 dark:bg-gray-900/50 border border-gray-300 dark:border-gray-700 rounded-lg text-gray-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all @error('password_confirmation') border-red-500 focus:ring-red-500 @enderror" 
                        required 
                        autocomplete="new-password"
                    />
                ...
                <!-- Submit Button -->
                <button type="submit" class="w-full py-3 px-4 bg-gradient-to-r from-primary-900 to-primary-700 hover:from-primary-800 hover:to-primary-600 text-white font-medium rounded-lg shadow-lg shadow-primary-900/30 hover:shadow-xl hover:shadow-primary-900/40 transition-all transform hover:-translate-y-0.5">
                    Create Account
                </button>
        ...
        <!-- Login Link -->
        <div class="px-6 py-3.5 bg-gray-50 dark:bg-gray-900/50 border-t border-gray-200 dark:border-gray-700">
