...
<div class="container mx-auto px-4 py-8 sm:py-10 lg:py-12">
    @if(session('success'))
    <div class="mb-6 px-4 py-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg text-sm text-green-700 dark:text-green-400">
        {{ session('success') }}
    </div>
    @endif
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12">
        ...
        <div>
            ...
            <form method="POST" action="{{ route('contact.submit') }}" class="space-y-4 sm:space-y-5">
                @csrf
        ...
        <div>
            ...
            <div class="space-y-6 mb-8">
                ...
                <div class="flex gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-400">
                            {{ config('app.shop_address', 'Dhaka, Bangladesh') }}
                        </p>
                    </div>
                </div>
                ...
                <div class="flex gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-400">
                            {{ config('app.shop_email', 'support@neonman.com') }}
                        </p>
                    </div>
                </div>
            ...
            <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 rounded-lg p-6">
                ...
                <div class="flex gap-3">
                    <a href="{{ config('app.facebook_url', '#') }}" target="_blank" rel="noopener" class="w-10 h-10 rounded-full bg-white dark:bg-gray-700 flex items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-primary-900 hover:text-white transition-colors">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                        </svg>
                    </a>
                    <a href="{{ config('app.instagram_url', '#') }}" target="_blank" rel="noopener" class="w-10 h-10 rounded-full bg-white dark:bg-gray-700 flex items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-primary-900 hover:text-white transition-colors">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ config('app.twitter_url', '#') }}" target="_blank" rel="noopener" class="w-10 h-10 rounded-full bg-white dark:bg-gray-700 flex items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-primary-900 hover:text-white transition-colors">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
