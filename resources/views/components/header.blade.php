        ...
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between h-20 lg:h-24">
                ...
                <div class="flex items-center space-x-2 sm:space-x-4">
                    ...
                    <!-- Shopping Cart -->
                    <button type="button" onclick="window.dispatchEvent(new Event('open-cart'))" id="cartIcon" class="relative p-2 text-gray-700 dark:text-gray-300 hover:text-primary-900 dark:hover:text-primary-400 transition-colors">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        @endphp
                        <span id="cartBadge" class="cart-count-badge absolute -top-1 -right-1 bg-primary-900 text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center {{ $cartCount > 0 ? '' : 'hidden' }}">
                            {{ $cartCount }}
                        </span>
                    </button>
